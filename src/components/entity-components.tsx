...
import { WorkflowEmpty } from "@/features/workflows/components/workflows";
...
export const WorkflowsList = () => {
  ...
  return (
    <EntityList
      ...
      renderItems={(workflow) => <p>{workflow.name}</p>}
...
export const LoadingView = ({ message }: LoadingViewProps) => {
  return (
    <div className="flex justify-center items-center h-full flex-1 flex-col gap-y-4">
      <Loader2Icon className="size-6 animate-spin text-muted-foreground text-primary" />
...
export const ErrorView = ({ message }: StateViewProps) => {
  return (
    <div className="flex justify-center items-center h-full flex-1 flex-col gap-y-4">
      <AlertTriangleIcon className="size-6 animate-spin text-muted-foreground text-primary" />
      {!!message && <p className="text-sm text-muted-foreground">{message}</p>}
    </div>
  );
};
